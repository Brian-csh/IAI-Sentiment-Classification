...
if __name__ == '__main__':
    ...
    for step in tqdm(range(1, epochs+1)):
        ...
        x_plot = step - 1
        writer.add_scalar("Train Loss", train_loss, x_plot)
        writer.add_scalar("Train Acc", train_acc, x_plot)
        writer.add_scalar("Train f1", train_f1, x_plot)
        writer.add_scalar("Validation Loss", validation_loss, x_plot)
        writer.add_scalar("Validation Acc", validation_acc, x_plot)
        writer.add_scalar("Validation f1", validation_f1, x_plot)
        writer.add_scalar("Test Loss", test_loss, x_plot)
        writer.add_scalar("Test Acc", test_acc, x_plot)
        writer.add_scalar("Test f1", test_f1, x_plot)
